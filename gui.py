...
# Import default messages from separate file
try:
...
class WhatsAppLinkGenerator:
    ...
    def clean_phone_number(phone_number):
        """Remove dashes, spaces, and ensure proper formatting"""
        # Remove all non-digit characters except '+'
        cleaned = ''.join(filter(str.isdigit, phone_number))
        
        # Remove leading 0 if present and add 6 if not already starting with 6
    ...
    def generate_whatsapp_link(phone_number):
        ...
        cleaned_number = WhatsAppLinkGenerator.clean_phone_number(phone_number)
...
class MessageManager:
    ...
    def load_messages(self):
        """Load messages from Python file"""
        if os.path.exists(self.filename):
            try:
                # Import the messages from the Python file
    ...
    def create_default_messages_file(self):
        """Create the messages file with default messages"""
...
def main(page: ft.Page):
    # Window configuration for 9:16 aspect ratio
    ...
    def generate_whatsapp_link(e):
        ...
        try:
            whatsapp_link = WhatsAppLinkGenerator.generate_whatsapp_link(phone_number)
    ...
    generate_btn = ft.ElevatedButton(
        ...
        icon=ft.Icons.LINK,
        on_click=generate_whatsapp_link,
        style=ft.ButtonStyle(
            shape=ft.RoundedRectangleBorder(radius=8),
            elevation=8
        )
